		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comisatisatui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comisatisatui5-display": {
								"semanticObject": "comisatisatui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.isat.isatui5",
									"url": sap.ui.require.toUrl("com/isat/isatui5")
								}
							}
						}
					}
